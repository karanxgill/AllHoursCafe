...
namespace AllHoursCafe.API.Migrations
{
    ...
    [Migration("20250425112112_AddStatusAndTransactionIdToTestBooking")]
    partial class AddStatusAndTransactionIdToTestBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.MenuHighlight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.SavedAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.MenuHighlight", b =>
                {
                    b.HasOne("AllHoursCafe.API.Models.MenuItem", "MenuItem")
                        .WithMany()
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.OrderItem", b =>
                {
                    b.HasOne("AllHoursCafe.API.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("AllHoursCafe.API.Models.SavedAddress", b =>
                {
                    b.HasOne("AllHoursCafe.API.Models.User", "User")
                        .WithMany()
